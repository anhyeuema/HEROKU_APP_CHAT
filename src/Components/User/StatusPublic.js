...
export default class User extends Component {
        ...
        this.socket.on('connect', () => {
            ...
            getToken('@Username')
                .then(user => {
                    ...
                    console.log(' serser app dang emit this.state.User o User.js', dataUser);
    ...
    uploadImage() {
        if (this.state.avatarSourceUpLoadBase64 !== null) {
            console.log('uploadImageuploadImage uploadImage');
            const nameSend = this.state.User;
    ...
    Share() {
        ...
        var dataEmit = {
            ...
            StatusMe: this.state.textStatus,
            // imaBase64: this.state.imaBase64,
            imaBase64: '',
            pathIma: this.state.pathIma
        }
        this.socket.emit('client-share-status-public-congKhai', dataEmit);
        console.log('dataEmit:dataEmit', dataEmit);
    }


    render() {
        var ima1 = 'http://localhost:2800/upload/1549127159230_avatar.jpg';
        return (
                    ...
                    renderItem={({ item }) =>
                        <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
                            ...
                            <View style={{ justifyContent: 'center', alignItems: 'center', }}>
                                <View
                                    style={{
                                        height: item.avata == null ? 0 : avataHeight,
                                        backgroundColor: 'yellow'
                                    }}>

                                    <View
                                        style={{
                                            height: (item.anhbia == null ? 0 : avataHeight),
                                            marginBottom: (item.anhbia == null ? 0 : 30),
                                            flexDirection: 'row',
                                        }}>
                                ...
                                <View
                                    style={{
                                        backgroundColor: 'red',
                                        height: (item.avata) == null ? 0 : 50,
                                        marginTop: (item.avata == null ? 0 : 70),
                                        marginBottom: (item.avata == null ? 0 : 90),
                                    ...
                                    <View
                                        style={{
                                            backgroundColor: 'red',
                                            marginTop: (item.avata == null ? 0 : 10),
                                        ...
                                        <TouchableOpacity
                                            style={{ height: (item.avata) == null ? 0 : 50, width: (item.avata) == null ? 0 : 80 }} onPress={() => { this.uploadImage() }} >
                                            <Text >{item.avata == null ? null : 'UI'}</Text>
                                        </TouchableOpacity>
                                ...
                                <View style={{
                                    ...
                                    // height: (item.StatusMe == null ? 0 : avataHeight),
                                    justifyContent: 'center', alignItems: 'center'
                                }}>
                                    <View key={item.key}
                                        style={{
