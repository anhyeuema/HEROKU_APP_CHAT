...
export default class ChatUser5 extends Component {
    constructor(props) {
        super(props);
            ...
            <View style={{ flex: 1, backgroundColor: '#fff' }}>
                ...
                <View style={{ flexDirection: 'row' }}>
                    ...
                    <View style={{ flex: 1, backgroundColor: '#fff', flexDirection: 'row' }} >
                        <Text style={styles.styleText} >User000000</Text>
                        <Text style={styles.UserOnline}>ChatUser5555: {this.state.Username === null ? null : this.state.Username}</Text>
