...
export default class ChatUsername extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            imageBase64: '',
            pathIma: 'http://192.168.216.2:2400/hotgirls/7.jpg',
        ...
        this.socket.on('server-send-messenger', async (dataMessenger) => {
          ...
          //  console.log('ArrSocketId_UserSend this.state.ArrSocketId_UserSend:::', this.state.ArrSocketId_UserSend);
            ...
            await this.socket.emit('client-muon-lay-ArrayMess-User', {
                ...
                UserYeuCauMess: UserApp, //tu thang nay o server cung co the tim ra socket id thoa man, 
                //nen su dung se chi can viet o server la su lu ca o app va web duoc
            });
            await this.socket.on('server-trave-yeucau-ArrayMess-User', async (SaveDataMessengerApp_r) => {
                ...
                if (SaveDataMessengerApp.length == 1 && SaveDataMessengerApp[0] == '0') { //neu ton tai SaveDataMessengerApp_r
                    ...
                    //    console.log('verver-trave-yeucau-ArrayMessUser::==0 dataMessenger:::', dataMessenger)
                        ...
                        var SaveDataMessengerApp1 = await JSON.stringify(this.state.SaveDataMessengerApp);
                        var ArrayMessUsersendUserItem = {
                            ...
                            SaveDataMessengerApp: SaveDataMessengerApp1, // dataMessenger la mang san roi
                        }
                ...
                if (SaveDataMessengerApp.length > 1 && SaveDataMessengerApp[0] == '[') { //neu ArrayMessUsersendUserItem[0]  khac rong thi ta JSON.parser
                    if (dataMessenger[0] !== null) {
                       ...
                       // console.log('var ArrdataMessenger =  this.state.SaveDataMessengerApp::::', ArrdataMessenger);
                        ...
                        // console.log('SaveDataMessengerApp1 trong socket.on.server-send-messenger::::', SaveDataMessengerApp1);
                        ...
                        this.socket.emit('client-send-ArrayMessUsersendUserItem', ArrayMessUsersendUserItem);
                        console.log('client-send-ArrayMessUsersendUserItem tra ve  phan la2222222222222222 string !==0::::', ArrayMessUsersendUserItem);
    ...
    render() {
        ...
        var ima1 = 'http://192.168.216.2:2400/hotgirls/1.jpg'
        return (
                                    ...
                                    <TouchableOpacity onPress={() => {
                                        ...
                                        if (Username !== "") {
                                            ...
                                            this.socket.on('server-trave-yeucau-ArrayMess-User', SaveDataMessengerApp_r => {
                                                console.log('server-trave-yeucau-ArrayMess-User flatlist::', SaveDataMessengerApp_r);
                                    ...
                                    renderItem={({ item }) =>
                                        ...
                                        <View style={{ flex: 1 }}>
                                            <View style={{ flexDirection: 'column' }} >
                                                ...
                                                <View style={{ flex: 1 }} />
                                                <View style={{ flex: 2, backgroundColor: 'red', width: (item.path == null ? 0 : avataWidth) }} >
                                            ...
                                            <View style={{ flex: 1, flexDirection: 'column' }}>
                                                <View style={{ flex: 1, flexDirection: 'row' }}>
                                                    ...
                                                    <View style={{ flex: 3, backgroundColor: 'yellow', height: (item.path == null ? 0 : avataHeight), width: (item.path == null ? 0 : avataWidth) }} >
                                                       {/*}
                                                        <Image source={{ uri: (item.pathIma == null ? ima1 : item.pathIma) }} style={styles.pathImaStyle} >
                                                        </Image>
                                                                */}
